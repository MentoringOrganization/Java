...
### static method에 대한 synchronized, instance method에 대한 synchronized, synchronized의 Block 무슨 차이가 있는가?
...
# 📚 예습
## 11. 웹 브라우저에 https://www.naver.com 를 입력했을 때, 어떤 일이 발생하여 브라우저에 네이버 창이 뜨는지 과정을 설명하라.
